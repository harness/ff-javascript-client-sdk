...
var getEventSource = function () {
    return function (url, headers) { return new EventSource(url, headers); };
};
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(configurations.baseUrl + "/client/env/" + environment + "/target/" + target.identifier + "/evaluations")];
                case 1:
                    res = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    platform.eventBus.emit('loading', true);
                    return [4 /*yield*/, fetch(configurations.baseUrl + "/client/env/" + environment + "/target/" + target.identifier + "/evaluations/" + identifier, {
                            headers: {
...
var authenticate = function (clientID, configuration) { return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch(configuration.baseUrl + "/client/auth", {
                        method: 'POST',
                        headers: {
