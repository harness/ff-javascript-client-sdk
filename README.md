...
```html
<script type="module">
  import { initialize, Event } from 'https://unpkg.com/@harnessio/ff-javascript-client-sdk@1.4.13/dist/sdk.client.js'
</script>
```
...
```html
<script src="https://unpkg.com/@harnessio/ff-javascript-client-sdk@1.4.13/dist/sdk.client.js"></script>
<script>
