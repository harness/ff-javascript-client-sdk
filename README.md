...
```html
<script type="module">
  import { initialize, Event } from 'https://unpkg.com/@harnessio/ff-javascript-client-sdk@1.4.1/dist/sdk.client.js'
</script>
```
...
```html
<script src="https://unpkg.com/@harnessio/ff-javascript-client-sdk@1.4.1/dist/sdk.client.js"></script>
<script>
...
Remember to change the version `1.4.1` in the unpkg url accordingly.
